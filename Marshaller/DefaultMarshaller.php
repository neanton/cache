...
class DefaultMarshaller implements MarshallerInterface
{
     ...
     * {@inheritdoc}
     */
    public function marshall(array $values, array &$failed)
    {
        $serialized = $failed = [];
    ...
    public function unmarshall($value)
    {
        ...
        static $igbinaryNull;
        if ($value === (isset($igbinaryNull) ? $igbinaryNull : $igbinaryNull = \extension_loaded('igbinary') && (\PHP_VERSION_ID < 70400 || version_compare('3.1.0', phpversion('igbinary'), '<=')) ? igbinary_serialize(null) : false)) {
            return null;
        }
